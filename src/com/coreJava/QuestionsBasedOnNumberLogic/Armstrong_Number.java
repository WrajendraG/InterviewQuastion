...
public class Armstrong_Number {
	...
	public static void main1(String[] args) {
		...
		int num = scanner.nextInt(); // whenever you are doing operation num
										// value update
		keep_Orignal_Number_for_check = num; // thats why i store num value
		...
		while (num > 0) {
			...
			Sum = Sum + (a * a * a); // here get cube of one digit and store
										// global variable
			// now i want minimize that number for next loop or finding next
			// cube
	...
	public static void main(String[] args) {
		...
		for (long i = 0; i < 975806; i++) {

			long keep_Orignal_Number_for_check, Sum = 0;

			long num = i; // whenever you are doing operation num value update
			keep_Orignal_Number_for_check = num; // thats why i store num value
													// different variable for
													// comparison
			while (num > 0) {
...
/*
 *
 * Enter you are number to be check armstrong or not = 153 Entered Number is
 * ArmStrong
 * 
 * 
 * Enter you are number to be check armstrong or not = 245 Entered Number is not
 * ArmStrong
 * 
 */
